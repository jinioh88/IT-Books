...
import com.example.ch04.oauth.ClientResources;
...
import static com.example.ch04.domain.enums.SocialType.FACEBOOK;
import static com.example.ch04.domain.enums.SocialType.GOOGLE;
import static com.example.ch04.domain.enums.SocialType.KAKAO;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .and()
                    ...
                    .addFilterBefore(oauth2Fileter(), BasicAuthenticationFilter.class)
                    .csrf().disable();
    }
    ...
    private Filter oauth2Filter(ClientResources client, String path, SocialType socialType) {
        ...
        filter.setAuthenticationFailureHandler((request,response, ,execption)->response.sendRedirect("/error"));
    }
